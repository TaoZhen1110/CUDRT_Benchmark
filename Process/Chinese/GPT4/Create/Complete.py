...
json_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/GPT4/Chinese/Create/Complete"
    ...
    if filename.endswith(".json"):
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                AI_Content = item['GPT4_Complete_Content'].replace("\n", "")
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT4/Create/Complete.json', 'w', encoding='utf-8') as file:
