...
json_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/GPT4/Chinese/Create/QA"
    ...
    if filename.endswith(".json"):
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                AI_Answer = item['GPT4_Answer'].replace("\n", "")
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT4/Create/QA.json', 'w', encoding='utf-8') as file:
