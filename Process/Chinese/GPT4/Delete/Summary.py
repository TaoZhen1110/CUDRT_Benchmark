...
file_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/GPT4/Chinese/Delete/Summary/Summary_News.json"
with open(file_path, 'r', encoding='utf-8') as f:
    for line in f:
        if "GPT4_Content" in line:
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT4/Delete/Summary.json', 'w', encoding='utf-8') as file:
