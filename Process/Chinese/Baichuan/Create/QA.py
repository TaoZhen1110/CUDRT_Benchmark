...
json_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Baichuan/Chinese/Create/QA"
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Create/QA.json', 'w', encoding='utf-8') as file:
