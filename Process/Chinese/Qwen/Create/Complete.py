...
json_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Qwen/Chinese/Create/Complete"
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Qwen/Create/Complete.json', 'w', encoding='utf-8') as file:
