...
json_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Qwen/Chinese/Create/QA"
    ...
    if filename.endswith(".json"):
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                AI_Answer = item['Qwen_Answer'].replace("\n", "")
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Qwen/Create/QA.json', 'w', encoding='utf-8') as file:
