...
file_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Qwen/Chinese/Delete/Summary/Summary_News.json"
with open(file_path, 'r', encoding='utf-8') as f:
    for line in f:
        ...
        AI_Content = item['Qwen_Content'].replace("\n", "")
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Qwen/Delete/Summary.json', 'w', encoding='utf-8') as file:
