...
file_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/ChatGLM/Chinese/Delete/Summary/Summary_News.json"
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/ChatGLM/Delete/Summary.json', 'w', encoding='utf-8') as file:
