...
file_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/GPT3.5/Chinese/Delete/Summary/Summary_News.json"
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT3.5/Delete/Summary.json', 'w', encoding='utf-8') as file:
