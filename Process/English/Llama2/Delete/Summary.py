...
file_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Llama2/English/Delete/Summary/Summary_News.json"
with open(file_path, 'r', encoding='utf-8') as f:
    for line in f:
        ...
        AI_Content = item['Llama2_Content'].replace("\n", "")
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Llama2/Delete/Summary.json', 'w', encoding='utf-8') as file:
