...
file_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Qwen/English/Delete/Summary/Summary_News.json"
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Qwen/Delete/Summary.json', 'w', encoding='utf-8') as file:
