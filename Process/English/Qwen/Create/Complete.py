...
json_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Qwen/English/Create/Complete"
    ...
    if filename.endswith(".json"):
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                AI_Content = item['Qwen_Complete_Content'].replace("\n", "")
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Qwen/Create/Complete.json', 'w', encoding='utf-8') as file:
