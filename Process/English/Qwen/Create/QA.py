...
json_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Qwen/English/Create/QA"
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Qwen/Create/QA.json', 'w', encoding='utf-8') as file:
