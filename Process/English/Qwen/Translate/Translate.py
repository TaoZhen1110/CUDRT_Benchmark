...
json_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Qwen/English/Translate"
    ...
    if filename.endswith(".json"):
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                AI_Content = item['Qwen_English'].replace("\n", "")
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Qwen/Translate/Translate.json',
