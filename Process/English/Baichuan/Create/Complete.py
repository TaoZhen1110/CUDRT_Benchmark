...
json_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Baichuan/English/Create/Complete"
...
with open('/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Baichuan/Create/Complete.json', 'w', encoding='utf-8') as file:
