...
def main(args):
    ...
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Llama2/Delete/Summary.json", 'r') as f:
        data2_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Llama2/Rewrite/Rewrite.json", 'r') as f:
        data3 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Llama2/Translate/Translate.json", 'r') as f:
        data4 = json.load(f)
    ...
    for epoch in tqdm(range(args.resume_epoch, args.nepochs)):
        ...
        for step, sample_batched in enumerate(valloader):
            ...
            if step % num_iter_ts == num_iter_ts - 1:
                ...
                cur_f = mean_valAcc
                if cur_f > best_f:
                    save_path = os.path.join(save_dir, 'llama2_xlnet_en' + '.pth')
