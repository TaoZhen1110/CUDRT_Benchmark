...
def main(args):
    ...
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Baichuan/Update/Expand.json", 'r') as f:
        data1_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Baichuan/Update/Polish.json", 'r') as f:
        data1_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/ChatGLM/Update/Expand.json", 'r') as f:
        data2_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/ChatGLM/Update/Polish.json", 'r') as f:
        data2_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT3.5/Update/Expand.json", 'r') as f:
        data3_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT3.5/Update/Polish.json", 'r') as f:
        data3_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT4/Update/Expand.json", 'r') as f:
        data4_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT4/Update/Polish.json", 'r') as f:
        data4_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Qwen/Update/Expand.json", 'r') as f:
        data5_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Qwen/Update/Polish.json", 'r') as f:
        data5_2 = json.load(f)
    ...
    for epoch in tqdm(range(args.resume_epoch, args.nepochs)):
        ...
        for step, sample_batched in enumerate(valloader):
            ...
            if step % num_iter_ts == num_iter_ts - 1:
                ...
                cur_f = mean_valAcc
                if cur_f > best_f:
                    save_path = os.path.join(save_dir, 'update_roberta_ch' + '.pth')
