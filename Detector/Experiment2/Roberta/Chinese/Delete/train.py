...
def main(args):
    ...
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Baichuan/Delete/Refine.json", 'r') as f:
        data1_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Baichuan/Delete/Summary.json", 'r') as f:
        data1_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/ChatGLM/Delete/Refine.json", 'r') as f:
        data2_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/ChatGLM/Delete/Summary.json", 'r') as f:
        data2_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT3.5/Delete/Refine.json", 'r') as f:
        data3_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT3.5/Delete/Summary.json", 'r') as f:
        data3_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT4/Delete/Refine.json", 'r') as f:
        data4_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT4/Delete/Summary.json", 'r') as f:
        data4_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Qwen/Delete/Refine.json", 'r') as f:
        data5_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Qwen/Delete/Summary.json", 'r') as f:
        data5_2 = json.load(f)

    train_data = []
    train_data.extend(data1_1[0:3000])
    train_data.extend(data1_2[0:1500])
    train_data.extend(data2_1[0:3000])
    train_data.extend(data2_2[0:1500])
    train_data.extend(data3_1[0:3000])
    train_data.extend(data3_2[0:1500])
    train_data.extend(data4_1[0:3000])
    train_data.extend(data4_2[0:1500])
    train_data.extend(data5_1[0:3000])
    train_data.extend(data5_2[0:1500])
    ...
    for epoch in tqdm(range(args.resume_epoch, args.nepochs)):
        ...
        for step, sample_batched in enumerate(valloader):
            ...
            if step % num_iter_ts == num_iter_ts - 1:
                ...
                cur_f = mean_valAcc
                if cur_f > best_f:
                    save_path = os.path.join(save_dir, 'delete_roberta_ch' + '.pth')
