...
from dataprepare import datapre1_complete, datapre2_complete, create_combined_dataloader
...
def main(args):
    ...
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Baichuan/Create/Complete.json", 'r') as f:
        data1_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Baichuan/Create/QA.json", 'r') as f:
        data1_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/ChatGLM/Create/Complete.json", 'r') as f:
        data2_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/ChatGLM/Create/QA.json", 'r') as f:
        data2_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT3.5/Create/Complete.json", 'r') as f:
        data3_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT3.5/Create/QA.json", 'r') as f:
        data3_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT4/Create/Complete.json", 'r') as f:
        data4_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/GPT4/Create/QA.json", 'r') as f:
        data4_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Qwen/Create/Complete.json", 'r') as f:
        data5_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/Chinese/Qwen/Create/QA.json", 'r') as f:
        data5_2 = json.load(f)
    ...
    train_data.extend(data2_2[0:3000])
    train_data.extend(data3_1[0:3000])
    train_data.extend(data3_2[0:3000])
    train_data.extend(data4_1[0:3000])
    train_data.extend(data4_2[0:3000])
    train_data.extend(data5_1[0:3000])
    train_data.extend(data5_2[0:3000])


    trainloader = create_combined_dataloader(dataset1 = datapre1_complete(jsondata = train_data, tokenizer=tokenizer),
                                            dataset2 = datapre2_complete(jsondata = train_data, tokenizer=tokenizer),
    ...
    val_data.extend(data2_2[3000:3750])
    val_data.extend(data3_1[3000:3750])
    val_data.extend(data3_2[3000:3750])
    val_data.extend(data4_1[3000:3750])
    val_data.extend(data4_2[3000:3750])
    val_data.extend(data5_1[3000:3750])
    val_data.extend(data5_2[3000:3750])


    valloader = create_combined_dataloader(dataset1 = datapre1_complete(jsondata = val_data, tokenizer=tokenizer),
                                            dataset2 = datapre2_complete(jsondata = val_data, tokenizer=tokenizer),
    ...
    for epoch in tqdm(range(args.resume_epoch, args.nepochs)):
        ...
        for step, sample_batched in enumerate(valloader):
            ...
            if step % num_iter_ts == num_iter_ts - 1:
                ...
                cur_f = mean_valAcc
                if cur_f > best_f:
                    save_path = os.path.join(save_dir, 'create_roberta_ch' + '.pth')
