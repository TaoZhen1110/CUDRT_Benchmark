...
def get_arguments():
    ...
    parser.add_argument("-checkpoint", type=str,
                        default='/mnt/data132/taozhen/LLMopen_Benchmark/Detector/XLNet/English/xlnet_pretrained/')
...
def main(args):
    ...
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Baichuan/Create/Complete.json", 'r') as f:
        data1_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Baichuan/Create/QA.json", 'r') as f:
        data1_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/ChatGLM/Create/Complete.json", 'r') as f:
        data2_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/ChatGLM/Create/QA.json", 'r') as f:
        data2_2 = json.load(f)
    ...
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/GPT3.5/Create/QA.json", 'r') as f:
        data3_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Llama2/Create/Complete.json", 'r') as f:
        data4_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Llama2/Create/QA.json", 'r') as f:
        data4_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Llama3/Create/Complete.json", 'r') as f:
        data5_1 = json.load(f)
    ...
    for epoch in tqdm(range(args.resume_epoch, args.nepochs)):
        ...
        for step, sample_batched in enumerate(valloader):
            ...
            if step % num_iter_ts == num_iter_ts - 1:
                ...
                cur_f = mean_valAcc
                if cur_f > best_f:
                    save_path = os.path.join(save_dir, 'create_xlnet_en' + '.pth')
