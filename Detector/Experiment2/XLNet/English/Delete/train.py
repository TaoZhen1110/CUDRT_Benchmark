...
def main(args):
    ...
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Baichuan/Delete/Refine.json", 'r') as f:
        data1_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Baichuan/Delete/Summary.json", 'r') as f:
        data1_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/ChatGLM/Delete/Refine.json", 'r') as f:
        data2_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/ChatGLM/Delete/Summary.json", 'r') as f:
        data2_2 = json.load(f)
    ...
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/GPT3.5/Delete/Summary.json", 'r') as f:
        data3_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Llama2/Delete/Refine.json", 'r') as f:
        data4_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Llama2/Delete/Summary.json", 'r') as f:
        data4_2 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Llama3/Delete/Refine.json", 'r') as f:
        data5_1 = json.load(f)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/Llama3/Delete/Summary.json", 'r') as f:
        data5_2 = json.load(f)
    ...
    for epoch in tqdm(range(args.resume_epoch, args.nepochs)):
        ...
        for step, sample_batched in enumerate(valloader):
            ...
            if step % num_iter_ts == num_iter_ts - 1:
                ...
                cur_f = mean_valAcc
                if cur_f > best_f:
                    save_path = os.path.join(save_dir, 'delete_xlnet_en' + '.pth')
