...
with open("/mnt/data132/taozhen/LLMopen_Benchmark/Detector/Roberta/Chinese/dataset/all.jsonl", "r", encoding="utf-8") as f:
    for line in f:
        data = json.loads(line)
        if data["human_answers"][0] is not None and data["chatgpt_answers"][0] is not None:
