...
import sys
sys.path.append('/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/Chinese/Roberta')
...
def get_arguments():
    ...
    parser.add_argument("-model_path", type=str,
                        default='/mnt/data132/taozhen/LLMopen_Benchmark/Detector/Roberta/Chinese/run_text/run_0/origin_roberta_ch.pth')
...
def main(args):
    ...
    new_result = {
        "Type": "Chinese_Roberta_Baichuan_Complete",
        "accuracy": accuracy,
        "precision": precision,
        "recall": recall,
        "f1_score": f1
