...
## 加载预测标签函数
English_model = pipeline('text-classification',
                         model = "/mnt/data132/taozhen/LLMopen_Benchmark/Detector/MPU/English_v2/")
...
# 加载文件
file_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetFinal/English/ChatGLM/Translate/Translate.json"
...
for item in last_1000_data:
    ...
    for paragraph1 in AI_paragraphs:
        ...
        if pre_result1 is not None and pre_result1[0]["label"] == "LABEL_0":
            AI_list += np.array([pre_result1[0]["score"], 1-pre_result1[0]["score"]])
        elif pre_result1 is not None and pre_result1[0]["label"] == "LABEL_1":
    ...
    for paragraph2 in Human_paragraphs:
        ...
        if pre_result2 is not None and pre_result2[0]["label"] == "LABEL_0":
            Human_list += np.array([pre_result2[0]["score"], 1 - pre_result2[0]["score"]])
        elif pre_result2 is not None and pre_result2[0]["label"] == "LABEL_1":
...
new_result = {
    "Type": "English_MPU_ChatGLM_Translate",
    "accuracy": accuracy,
    "precision": precision,
    "recall": recall,
    "f1_score": f1
