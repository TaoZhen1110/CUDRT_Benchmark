...
import sys
sys.path.append('/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/English/XLNet')
...
def get_arguments():
    ...
    parser.add_argument("-model_path", type=str,
                        default='/mnt/data132/taozhen/LLMopen_Benchmark/Detector/XLNet/English/run_text/run_0/origin_xlnet_en.pth')
...
def main(args):
    ...
    new_result = {
        "Type": "English_XLNet_Baichuan_Complete",
        "accuracy": accuracy,
        "precision": precision,
        "recall": recall,
        "f1_score": f1
    ...
    print(new_result)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/English/Result.txt", 'a', encoding='utf-8') as file:
