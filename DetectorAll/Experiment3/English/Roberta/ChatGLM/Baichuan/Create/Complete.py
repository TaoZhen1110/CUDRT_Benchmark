...
import sys
sys.path.append('/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/Experiment3/English/Roberta/ChatGLM/')
...
def get_arguments():
    ...
    parser.add_argument("-model_path", type=str,
                        default='/mnt/data132/taozhen/LLMopen_Benchmark/Detector/Experiment3/Roberta/English/ChatGLM/run_text/run_0/chatglm_roberta_en.pth')
...
def main(args):
    ...
    new_result = {
        "Type": "English_Roberta_ChatGLM_Baichuan_Complete",
        "accuracy": accuracy,
        "precision": precision,
        "recall": recall,
        "f1_score": f1
