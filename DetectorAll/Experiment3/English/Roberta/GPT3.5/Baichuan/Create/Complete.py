...
import sys
sys.path.append('/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/Experiment3/English/Roberta/GPT3.5/')
...
def get_arguments():
    ...
    parser.add_argument("-model_path", type=str,
                        default='/mnt/data132/taozhen/LLMopen_Benchmark/Detector/Experiment3/Roberta/English/GPT3.5/run_text/run_0/gpt3.5_roberta_en.pth')
...
def main(args):
    ...
    new_result = {
        "Type": "English_Roberta_GPT3.5_Baichuan_Complete",
        "accuracy": accuracy,
        "precision": precision,
        "recall": recall,
        "f1_score": f1
