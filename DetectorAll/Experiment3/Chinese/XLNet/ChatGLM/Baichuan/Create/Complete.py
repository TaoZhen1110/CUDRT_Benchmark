...
import sys
sys.path.append('/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/Experiment3/Chinese/XLNet/ChatGLM/')
...
def get_arguments():
    ...
    parser.add_argument("-model_path", type=str,
                        default='/mnt/data132/taozhen/LLMopen_Benchmark/Detector/Experiment3/XLNet/Chinese/ChatGLM/run_text/run_0/chatglm_xlnet_ch.pth')
...
def main(args):
    ...
    new_result = {
        "Type": "Chinese_XLNet_ChatGLM_Baichuan_Complete",
        "accuracy": accuracy,
        "precision": precision,
        "recall": recall,
        "f1_score": f1
