...
import sys
sys.path.append('/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/Experiment2/English/Roberta/Update/')
...
def get_arguments():
    ...
    parser.add_argument("-model_path", type=str,
                        default='/mnt/data132/taozhen/LLMopen_Benchmark/Detector/Experiment2/Roberta/English/Update/run_text/run_0/update_roberta_en.pth')
...
def main(args):
    ...
    new_result = {
        "Type": "English_Roberta_Update_Baichuan_Complete",
        "accuracy": accuracy,
        "precision": precision,
        "recall": recall,
        "f1_score": f1
