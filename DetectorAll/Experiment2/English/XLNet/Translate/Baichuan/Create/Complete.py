...
import sys
sys.path.append('/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/Experiment2/English/XLNet/Translate/')
...
def get_arguments():
    ...
    parser.add_argument("-model_path", type=str,
                        default='/mnt/data132/taozhen/LLMopen_Benchmark/Detector/Experiment2/XLNet/English/Translate/run_text/run_0/translate_xlnet_en.pth')
...
def main(args):
    ...
    testloader = create_combined_dataloader(dataset1 = datapre1_complete(jsondata = last_test_data, tokenizer=tokenizer),
                                            dataset2 = datapre2_complete(jsondata = last_test_data, tokenizer=tokenizer),
    ...
    new_result = {
        "Type": "English_XLNet_Translate_Baichuan_Complete",
        "accuracy": accuracy,
        "precision": precision,
        "recall": recall,
        "f1_score": f1
    ...
    print(new_result)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/Experiment2/English/Result.txt", 'a', encoding='utf-8') as file:
