...
import sys
sys.path.append('/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/Experiment2/Chinese/XLNet/Delete/')
...
def get_arguments():
    ...
    parser.add_argument("-model_path", type=str,
                        default='/mnt/data132/taozhen/LLMopen_Benchmark/Detector/Experiment2/XLNet/Chinese/Delete/run_text/run_0/delete_xlnet_ch.pth')
...
def main(args):
    ...
    new_result = {
        "Type": "Chinese_XLNet_Delete_Baichuan_Complete",
        "accuracy": accuracy,
        "precision": precision,
        "recall": recall,
        "f1_score": f1
