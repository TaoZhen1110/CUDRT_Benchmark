...
import sys
sys.path.append('/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/Experiment2/Chinese/Roberta/Translate/')
...
def get_arguments():
    ...
    parser.add_argument("-model_path", type=str,
                        default='/mnt/data132/taozhen/LLMopen_Benchmark/Detector/Experiment2/Roberta/Chinese/Translate/run_text/run_0/translate_roberta_ch.pth')
...
def main(args):
    ...
    new_result = {
        "Type": "Chinese_Roberta_Translate_Baichuan_Complete",
        "accuracy": accuracy,
        "precision": precision,
        "recall": recall,
        "f1_score": f1
    ...
    print(new_result)
    with open("/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/Experiment2/Chinese/Result.txt", 'a', encoding='utf-8') as file:
