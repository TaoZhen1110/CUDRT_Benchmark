...
import sys
sys.path.append('/mnt/data132/taozhen/LLMopen_Benchmark/DetectorAll/Experiment2/Chinese/Roberta/Rewrite/')
...
def get_arguments():
    ...
    parser.add_argument("-model_path", type=str,
                        default='/mnt/data132/taozhen/LLMopen_Benchmark/Detector/Experiment2/Roberta/Chinese/Rewrite/run_text/run_0/rewrite_roberta_ch.pth')
...
def main(args):
    ...
    new_result = {
        "Type": "Chinese_Roberta_Rewrite_Baichuan_Complete",
        "accuracy": accuracy,
        "precision": precision,
        "recall": recall,
        "f1_score": f1
