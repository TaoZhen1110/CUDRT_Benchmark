...
def English_Complete(item):
    ...
    new_item = {
        ...
        'Llama2_Complete_Content': item["Human_Splitcontent_0.25"] + response_content
    }
    return new_item
...
if __name__ == "__main__":
    ...
    data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Llama2/English/Create/Complete/Complete_Thesis_ratio75.json"
