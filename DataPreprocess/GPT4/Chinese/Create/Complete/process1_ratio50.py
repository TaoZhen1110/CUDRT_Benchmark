...
def Chinese_Complete(item):
    ...
    prompt = f"""
        ...
        现在我有一个不完整的新闻，需要你帮忙补全。你的补全文本需要符合新闻领域的规范与表达。\
    ...
    new_item = {
        ...
        'GPT4_Complete_Content': item["Human_Splitcontent_0.50"] + response_content
    }
    return new_item
...
if __name__ == "__main__":
    ...
    origin_data_path = "/home/taoz/AIGC_Detection_Benchmark/Dataset2/Chinese/Create/Complete/News/News_ratio50.json"
    data_path = "/home/taoz/AIGC_Detection_Benchmark/DatasetAll/GPT4/Chinese/Create/Complete/Complete_News_ratio50.json"
