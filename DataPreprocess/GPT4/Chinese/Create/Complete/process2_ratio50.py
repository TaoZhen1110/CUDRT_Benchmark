...
def Chinese_Complete(item):
    ...
    prompt = f"""
        ...
        现在我有一个不完整的中文论文，需要你帮忙补全。你的补全文本需要符合论文领域的规范与表达。\
...
if __name__ == "__main__":
    ...
    data_path = "/home/taoz/AIGC_Detection_Benchmark/DatasetAll/GPT4/Chinese/Create/Complete/Complete_Thesis_ratio50.json"
