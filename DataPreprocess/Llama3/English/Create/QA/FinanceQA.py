...
if __name__ == "__main__":
    ...
    origin_data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/Dataset2/English/Create/QA/FinanceQA.json"
    data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Llama3/English/Create/QA/QA_Finance.json"
