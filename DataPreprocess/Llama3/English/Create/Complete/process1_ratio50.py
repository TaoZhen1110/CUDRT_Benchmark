...
def English_Complete(item):
    ...
    new_item = {
        ...
        'Llama3_Complete_Content': item["Human_Splitcontent_0.50"] + response_content
    }
    return new_item
...
if __name__ == "__main__":
    ...
    origin_data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/Dataset2/English/Create/Complete/News_ratio50_1.json"
    data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Llama3/English/Create/Complete/Complete_News_ratio50.json"

    if not os.path.exists(data_path):
        print("Creating Complete_News_ratio50.json")
        ...
        print("Loading Complete_News_ratio50.json")
        IDfile2_set = set()
        missing_items = []
