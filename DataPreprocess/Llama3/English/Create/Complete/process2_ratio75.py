...
def English_Complete(item):
    ...
    new_item = {
        ...
        'Llama3_Complete_Content': item["Human_Splitcontent_0.25"] + response_content
    }
    return new_item
...
if __name__ == "__main__":
    ...
    origin_data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/Dataset2/English/Create/Complete/Thesis_ratio75_1.json"
    data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Llama3/English/Create/Complete/Complete_Thesis_ratio75.json"
