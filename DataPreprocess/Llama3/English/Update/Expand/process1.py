...
def get_response(prompt):
    ...
    url = "http://172.27.33.133:8104/generate"      # /mnt/huggingface/models/Llama-3-8B-Instruct/
...
def English_Expand(item):
    ...
    prompt = f"""
        ...
        I currently have an English news that I need your help to expand.\
        Your expansion needs to conform to the standards and expressions of the news writing.
    ...
    new_item = {
        'ID': item['ID'],
        'Type': "Expand_English_News",
        'Human_Abstract': item['Human_Abstract'],
        'Human_Content': item['Human_Content'],
        'Llama3_Content': response_content
    }
    return new_item
...
if __name__ == "__main__":
    ...
    origin_data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/Dataset2/English/Update/Expand/News.json"
    data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Llama3/English/Update/Expand/Expand_News.json"
