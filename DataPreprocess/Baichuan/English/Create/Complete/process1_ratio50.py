...
def English_Complete(item):
    ...
    new_item = {
        ...
        'Baichuan_Complete_Content': item["Human_Splitcontent_0.50"] + response_content
    }
    return new_item
...
if __name__ == "__main__":
    ...
    data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Baichuan/English/Create/Complete/Complete_News_ratio50.json"
