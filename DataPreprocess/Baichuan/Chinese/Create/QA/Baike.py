...
def Chinese_QA(item):
    ...
    prompt = f"""
        假设你是一名中文百科问答专家。请根据你的知识库，请提供以下问题的详细答案，并确保信息是准确无误的。
...
if __name__ == "__main__":
    ...
    origin_data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/Dataset2/Chinese/Create/QA/BaikeQA.json"
    data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Baichuan/Chinese/Create/QA/QA_Baike.json"

    if not os.path.exists(data_path):
        print("Creating QA_Baike.json")
