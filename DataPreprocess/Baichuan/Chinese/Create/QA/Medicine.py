...
def Chinese_Translate(item):
    ...
    prompt = f"""
        假设你是一名专注于回答患者的问答医生，请根据你的知识库来提供以下问题的详细答案，并确保信息是准确无误的。
...
if __name__ == "__main__":
    ...
    origin_data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/Dataset2/Chinese/Create/QA/MedicineQA.json"
    data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Baichuan/Chinese/Create/QA/QA_Medicine.json"
