...
def Chinese_Complete(item):
    ...
    prompt = f"""
        ...
        现在我有一个不完整的中文论文，需要你帮忙补全。你的补全文本需要符合论文的规范与表达。\
...
if __name__ == "__main__":
    ...
    origin_data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/Dataset2/Chinese/Create/Complete/Thesis_ratio50.json"
    data_path = "/mnt/data132/taozhen/LLMopen_Benchmark/DatasetAll/Baichuan/Chinese/Create/Complete/Complete_Thesis_ratio50.json"
