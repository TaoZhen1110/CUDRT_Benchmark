...
if __name__ == "__main__":
    ...
    origin_data_path = "/mnt/data134/taozhen/LLMopen_Benchmark/Dataset2/English/Rewrite/News.json"
    data_path = "/mnt/data134/taozhen/LLMopen_Benchmark/DatasetAll/Qwen/English/Rewrite/Rewrite_News.json"
