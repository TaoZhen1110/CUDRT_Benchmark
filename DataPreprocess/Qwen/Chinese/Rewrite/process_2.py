...
if __name__ == "__main__":
    ...
    origin_data_path = "/mnt/data134/taozhen/LLMopen_Benchmark/Dataset2/Chinese/Rewrite/Thesis.json"
    data_path = "/mnt/data134/taozhen/LLMopen_Benchmark/DatasetAll/Qwen/Chinese/Rewrite/Rewrite_Thesis.json"
