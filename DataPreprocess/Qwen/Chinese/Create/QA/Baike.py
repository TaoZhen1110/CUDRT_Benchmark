...
if __name__ == "__main__":
    ...
    origin_data_path = "/mnt/data134/taozhen/LLMopen_Benchmark/Dataset2/Chinese/Create/QA/BaikeQA.json"
    data_path = "/mnt/data134/taozhen/LLMopen_Benchmark/DatasetAll/Qwen/Chinese/Create/QA/QA_Baike.json"
