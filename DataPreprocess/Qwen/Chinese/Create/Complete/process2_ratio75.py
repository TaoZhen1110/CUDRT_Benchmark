...
def Chinese_Complete(item):
    ...
    new_item = {
        ...
        'Qwen_Complete_Content': item["Human_Splitcontent_0.25"] + response_content
    }
    return new_item
...
if __name__ == "__main__":
    ...
    origin_data_path = "/mnt/data134/taozhen/LLMopen_Benchmark/Dataset2/Chinese/Create/Complete/Thesis/Thesis_ratio75.json"
    data_path = "/mnt/data134/taozhen/LLMopen_Benchmark/DatasetAll/Qwen/Chinese/Create/Complete/Complete_Thesis_ratio75.json"
